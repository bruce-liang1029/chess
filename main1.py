...
# Always set these parameters before initialization of pygame
GRID = 100
...
# If a different picture is found, the pieces arrangement are different
# w and h divisor in w //= 4 h //= 3
pieces = pg.image.load('chess_pieces.png').convert(screen)
w, h = pieces.get_size()
w //= 4
h //= 3
# Try one piece first and show it on the screen before
#  writing all of them below
...
# Peek the width and height of the picture of one piece
