...
class Thinky(Player):
    ...
    def minimax(self, chess, depth, piece_images, alpha, beta): # 3. add alpha beta
        # 1. The theory behind alpha beta pruning
        ...
        if depth == 0:
            ...
            # 2. use math.inf to denote infinity
            ...
            for move in moves:
                ...
                # 6. apply alpha beta pruning and run again
